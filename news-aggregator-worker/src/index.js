  ...
  return `
    ...
    <body>
      <div class="login-card">
        ...
        <h1>Brief</h1>
        <p>Save articles from the web, understand them in your language, organize them for later, and share the insight.</p>
        ...
        <ul class="value-list"><li>Save pages or selected text</li><li>Summarize in your language</li><li>Organize, search, and share</li></ul>
